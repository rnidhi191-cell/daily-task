// schema
// const Salary = require("../model/salaray_schema.js")
const Insertdata = require("../model/insert_data_schema.js")
// const Role = require("../model/roll_schema.js");
// const salaray_schema = require("./model/salaray_schema.js");

const { body, param, validationResult } = require("express-validator");
const {add,subtract,mul}=require("./math")  // spelling + path both wrong


    
   exports.calculateMaths=  async(req,res)=>{
    try{
        const {a,b}=req.body
...
success:true
 ...
 exports.createStudent= async (req, res) => {
        try {
            // const student=new Insertdata(req.body);
            const errors = validationResult(req);
            console.log(errors)
            const student = await Insertdata.create(req.body)
            res.status(201).json({
                success: true,
                data: student
            })
